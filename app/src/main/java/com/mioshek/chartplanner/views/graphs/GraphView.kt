...
@Composable
fun ShowGraphBackground(modifier: Modifier = Modifier){
    ...
    Box(
        ...
        Column(
            ...
            Column(
                ...
                modifier = modifier
                    .fillMaxHeight(0.6f)
                    .padding(top = 20.dp, bottom = 10.dp, start = 25.dp, end = 10.dp)
                ...
                LineChart(
                    ...
                    appearance = GraphAppearance(
                        ...
                        1.dp,
                        true,
                        Pair(MaterialTheme.colorScheme.primary,Color.Green.copy(0.0f)),
                        true,
